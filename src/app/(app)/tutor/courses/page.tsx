...
import { Plus, Users, Star, Edit, Trash2, BookOpen } from "lucide-react";
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <select id="difficulty" className="w-full rounded-md border p-2">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={() => setIsOpen(false)}>Create Course</Button>
              </div>
            </div>
          </DialogContent>
        </Dialog>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {mockCourses.reduce((sum, course) => sum + course.enrolledCount, 0)}
            </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-6 text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>{Math.floor(course.duration / 60)}h duration</span>
                  </div>
                </div>
